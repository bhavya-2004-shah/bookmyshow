// const TheatreCard = ({ name, location }) => {
//   return (
//     <div className="flex items-center justify-between px-6 py-4 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition cursor-pointer">
